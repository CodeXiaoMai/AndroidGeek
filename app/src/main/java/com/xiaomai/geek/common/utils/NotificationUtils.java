...
public class NotificationUtils {
    ...
    public static void showNotification(@NonNull Context context, @NonNull Password password) {
        showNotification(context, password, TYPE_PASSWORD);
        showNotification(context, password, TYPE_USER_NAME);
    }
    ...
    @IntDef({TYPE_USER_NAME, TYPE_PASSWORD})
